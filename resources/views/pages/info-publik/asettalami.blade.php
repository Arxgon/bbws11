...
@section('title', 'BBWS-CITARUM | Tampungan Alami')
...
@section('content')
<x-jumbotron name="Tampungan Alami" />
<x-running-text />

<x-bread-crumb name="Tampungan Alami" />

<div class="container px-0 py-3 profile-container d-flex">
    <div class="p-4 row">
        <div class="col-12 col-lg-12">
            <h1>Tampungan Alami </h1>
            <hr>
            <!-- Post Content -->
            <style>
                #pdfview {
            ...
            <hr>
            <center>   <iframe id="pdfview" src="{{ asset('assets/pdf/Data Tampungan Alami.pdf') }}" frameborder="0"></iframe>
            </center></body>
        </div>
    </div>
