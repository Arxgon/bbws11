...
@section('title', 'BBWS-CITARUM | Pengendali Banjir')
...
@section('content')
<x-jumbotron name="Pengendali Banjir" />
<x-running-text />

<x-bread-crumb name="Pengendali Banjir" />

<div class="container px-0 py-3 profile-container d-flex">
    <div class="p-4 row">
        <div class="col-12 col-lg-12">
            <h1>Pengendali Banjir </h1>
            <hr>
            <!-- Post Content -->
                        <a 
                rel="prettyPhoto">
                <img class="img-fluid" src="{{ asset('assets/img/Peta Pengendali Banjir.jpg') }}">
            </a>
            <style>
                #pdfview {
                    width: 75%;
            ...
            <hr>
            <center>   <iframe id="pdfview" src="{{ asset('assets/pdf/Pengendali Banjir.pdf') }}" frameborder="0"></iframe>
            </center></body>
        </div>
    </div>
