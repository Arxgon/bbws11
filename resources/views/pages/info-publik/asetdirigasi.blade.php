...
@section('title', 'BBWS-CITARUM | Daerah Irigasi')
...
@section('content')
<x-jumbotron name="Daerah Irigasi" />
<x-running-text />

<x-bread-crumb name="Daerah Irigasi" />
...
<div class="container px-0 py-3 profile-container d-flex">
    <div class="p-4 row">
        <div class="col-12 col-lg-12">
            ...
            <!-- Post Content -->
                        <a rel="prettyPhoto">
                <img class="img-fluid" src="{{ asset('assets/img/Peta Daerah Irigasi.jpg') }}">
            </a>
            ...
            <hr>
            <center>   <iframe id="pdfview" src="{{ asset('assets/pdf/Data Daerah Irigasi.pdf') }}" frameborder="0"></iframe>
            </center>
        </div>
    </div>
