...
@section('title', 'BBWS-CITARUM | Daerah Rawan Kekeringan')
...
@section('content')
<x-jumbotron name="Daerah Rawan Kekeringan" />
<x-running-text />

<x-bread-crumb name="Daerah Rawan Kekeringan" />

<div class="container px-0 py-3 profile-container d-flex">
    <div class="p-4 row">
        <div class="col-12 col-lg-12">
            <h1>Daerah Rawan Kekeringan </h1>
            <hr>
            <!-- Post Content -->
                        <a rel="prettyPhoto">
