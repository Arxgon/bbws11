...
@section('title', 'BBWS-CITARUM | Embung')
...
@section('content')
<x-jumbotron name="Embung" />
<x-running-text />

<x-bread-crumb name="Embung" />
...
<div class="container px-0 py-3 profile-container d-flex">
    <div class="p-4 row">
        <div class="col-12 col-lg-12">
            ...
            <hr>
            <center>   <iframe id="pdfview" src="{{ asset('assets/pdf/Data Embung.pdf') }}" frameborder="0"></iframe>
            </center></body>
        </div>
    </div>
