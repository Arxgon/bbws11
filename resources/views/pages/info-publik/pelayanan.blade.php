    ...
    <div class="row">
        <div class="col-12 col-lg-8">
            <div class="card border-rounded bg-color-light border-2">
                ...
                <body>
                 <center>   <iframe id="pdfview" src="{{ asset('assets/pdf/SK PENETAPAN STANDAR PELAYANAN_2024.pdf') }}" frameborder="0"></iframe>
                 </center></body>
        ...
        <div class="py-2 side-nav" style="width:30%">
            <ul class="py-2 item-nav">
                ...
                <li class="active"><i class="fas fa-play text-primary"></i><a href="{{ route('info-publik.pelayanan') }}"><strong> Standar Pelayanan</strong></a></li>
