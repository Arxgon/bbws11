...
@section('title', 'BBWS-CITARUM | Aset Wilayah Sungai')
...
@section('content')
<x-jumbotron name="Wilayah Sungai Citarum" />
<x-running-text />

<x-bread-crumb name="Wilayah Sungai Citarum" />
<div class="container px-0 py-3 profile-container d-flex">
    <div class="p-4 row">
        <div class="col-12 col-lg-12">
            <h1>Wilayah Sungai Citarum</h1>
            <hr>
            <!-- Post Content -->
            <a 
                rel="prettyPhoto">
                <img class="img-fluid" src="{{ asset('assets/img/citarum.jpg') }}">
            </a>
            ...
            <hr>
            <!--    <h1 class="card-title text-4 font-weight text-primary">Input file disini (hapus ini)</h1> <hr>
            <center>   <iframe id="pdfview" src="{{ asset('assets/pdf/bendung.pdf') }}" frameborder="0"></iframe>
            </center></body> -->
        </div>
    </div>
