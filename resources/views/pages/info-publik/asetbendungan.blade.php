...
@section('title', 'BBWS-CITARUM | Bendungan')
...
@section('content')
<x-jumbotron name="Bendungan" />
<x-running-text />

<x-bread-crumb name="Bendungan" />
...
<div class="container px-0 py-3 profile-container d-flex">
    <div class="p-4 row">
        <div class="col-12 col-lg-12">
            <a 
                rel="prettyPhoto">
                <img class="img-fluid" src="{{ asset('assets/img/Peta Bendungan WS Citarum.jpg') }}">
            </a>
            <hr>
            <!-- Post Content -->
            <style>
            ...
            <hr>
            <center>   <iframe id="pdfview" src="{{ asset('assets/pdf/data bendungan.pdf') }}" frameborder="0"></iframe>
            </center></body>
        </div>
    </div>
